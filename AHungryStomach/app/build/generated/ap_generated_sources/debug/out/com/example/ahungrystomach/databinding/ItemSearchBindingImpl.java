...
public class ItemSearchBindingImpl extends ItemSearchBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.meal == variableId) {
            setMeal((com.example.ahungrystomach.models.MealDetail) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMeal(@Nullable com.example.ahungrystomach.models.MealDetail Meal) {
        this.mMeal = Meal;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        java.lang.String mealInstructions = null;
        com.example.ahungrystomach.models.MealDetail meal = mMeal;
        java.lang.String mealMeal = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                if (meal != null) {
                    // read meal.instructions
                    mealInstructions = meal.getInstructions();
                    // read meal.meal
                    mealMeal = meal.getMeal();
                }
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.desc, mealInstructions);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.name, mealMeal);
        }
    }
