...
public class ActivityCartBindingImpl extends ActivityCartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_empty, 1);
        ...
        sViewsWithIds.put(R.id.viewCart, 6);
        sViewsWithIds.put(R.id.cart, 7);
        sViewsWithIds.put(R.id.rc_cart, 8);
        sViewsWithIds.put(R.id.total_bar, 9);
        sViewsWithIds.put(R.id.tvAmount, 10);
        sViewsWithIds.put(R.id.total, 11);
        sViewsWithIds.put(R.id.tvHome, 12);
        sViewsWithIds.put(R.id.tv_checkout, 13);
    }
    // views
    @NonNull
